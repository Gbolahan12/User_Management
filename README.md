...
<p align="center">
To start, log into client-1 as the domain admin (sever _admin), using Remote Desktop Connection: <br/>
<img src="https://i.imgur.com/PEplAIZ.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/orgJBdW.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Here, enter "Domain Users" > Check Names > OK > OK. Now all domain users can access this client via Remote Desktop:  <br/>
<img src="https://i.imgur.com/ZQfSock.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Next, we'll create a bunch of users in Powershell. To start, log into the DC (Domain Controller) as our admin (sever _admin): <br/>
<img src="https://i.imgur.com/glWobnD.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Once logged in, open Powershell ISE as an admin and start a new script:  <br/>
<img src="https://i.imgur.com/qhFaJRT.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Use Ctrl + S and save this like so:  <br/>
<img src="https://i.imgur.com/Ja1k1fC.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/IQgEoU0.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/fy3J4mP.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
<br />
...
<img src="https://i.imgur.com/NXyGkBe.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Go back to our DC and right click the start button > Run > type "gpmc.msc" to bring up the Group Policy Managment Console:  <br/>
<img src="https://i.imgur.com/5FLfmRs.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Expand Domains > mydomain.com > select Default Domain Policy:  <br/>
<img src="https://i.imgur.com/lBUxxh2.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Under Computer Configuration expand Policies > Window Settings > Security Settings > select Account Lockout Policy:  <br/>
<img src="https://i.imgur.com/BrHnZMI.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/2GbtOOl.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/3xVqH07.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/30c63Ab.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/E6lcILP.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/eg53UVZ.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/Y4nsscI.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
This is because we are not an admin. Not to worry, we don't need to sign out of this whole client and sign in as sever admin(our admin). We already know her credentials. We just need to close out of this window and open it again, but this time, as an administrator. It will have a pop-up asking for admin credentials:  <br/>
<img src="https://i.imgur.com/jVMS47H.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
Now, if we navigate back to the security log page, we can view them:  <br/>
<img src="https://i.imgur.com/BGCXFBJ.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
...
<img src="https://i.imgur.com/MYFzp0W.png" height="80%" width="80%" alt="Setting Up in Azure"/>
<br />
<br />
